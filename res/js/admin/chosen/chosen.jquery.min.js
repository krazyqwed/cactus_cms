    ...
    SelectParser = function () {
        ...
        return d(Chosen, c), Chosen.prototype.setup = function () {
            ...
            return this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("chosen:maxselected", {
                ...
                chosen: this
            }), _this = this, setTimeout(function(){ windowHeight = $(window).height(), dropdownTop = _this.container.offset().top + _this.container.height() - $(window).scrollTop(), totalHeight = _this.dropdown.height() + dropdownTop, _this.dropdown.add(_this.container).toggleClass('chosen-above', totalHeight > windowHeight - 60)}, 1), this.results_showing = !0, this.search_field.focus(), this.search_field.val(this.search_field.val()), this.winnow_results())
        }, Chosen.prototype.update_results_content = function (a) {
            return this.search_results.html(a)
        }, Chosen.prototype.results_hide = function () {
            return this.results_showing && (this.result_clear_highlight(), this.container.removeClass("chosen-with-drop chosen-above"), this.form_field_jq.trigger("chosen:hiding_dropdown", {
                chosen: this
